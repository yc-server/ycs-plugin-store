...
export async function act(
  ...
  switch (action) {
    case EAction.CustomerCreate:
      event.emit(EAction.CustomerCreate, entity);
      break;
    case EAction.CustomerRefund:
      ...
      await entity.save();
      event.emit(EAction.CustomerRefund, entity);
      break;
    case EAction.CustomerCancel:
      ...
      await entity.save();
      event.emit(EAction.CustomerCancel, entity);
      break;
    case EAction.CustomerSign:
      ...
      await entity.save();
      event.emit(EAction.CustomerSign, entity);
      break;
    case EAction.CustomerComment:
      ...
      await entity.save();
      event.emit(EAction.CustomerComment, entity);
      break;
    case EAction.SupplierAccept:
      ...
      await entity.save();
      event.emit(EAction.SupplierAccept, entity);
      break;
    case EAction.SupplierReject:
      ...
      entity.status = EStatus.Cancelled;
      await entity.save();
      event.emit(EAction.SupplierReject, entity);
      break;
    case EAction.SupplierComplete:
      ...
      await entity.save();
      event.emit(EAction.SupplierComplete, entity);
      break;
    case EAction.SupplierRefundAccept:
      ...
      await entity.save();
      event.emit(EAction.SupplierRefundAccept, entity);
      break;
    case EAction.SupplierRefundReject:
      ...
      await entity.save();
      event.emit(EAction.SupplierRefundReject, entity);
      break;
    case EAction.SystemRefundComplete:
      ...
      await entity.save();
      event.emit(EAction.SystemRefundComplete, entity);
      break;
    case EAction.SystemError:
      event.emit(EAction.SystemError, entity);
      break;
    case EAction.SystemPay:
      ...
      await entity.save();
      event.emit(EAction.SystemPay, entity);
      break;
    default:
